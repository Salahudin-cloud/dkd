                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo base_url() . 'assets/frontend/img/dkd/infaq_subuh.png' ?>" alt="">
                            </div>
                            <div class="cases-caption">
                                ...
                                <div class="prices d-flex justify-content-between">
                                    <p>Terkumpul:<span> Rp 357.000</span></p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo base_url() . 'assets/frontend/img/dkd/patungan_pesantren.png' ?>" alt="">
                            </div>
                            <div class="cases-caption">
                                ...
                                <!-- / progress -->
                                <div class="prices d-flex justify-content-between">
                                    <p>Terkumpul:<span> Rp 2.500.000</span></p>
                                    <p>Target:<span> - </span></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo base_url() . 'assets/frontend/img/dkd/sedekah.jpg' ?>" alt="">
                            </div>
                            <div class="cases-caption">
                                ...
                                <!-- / progress -->
                                <div class="prices d-flex justify-content-between">
                                    <p>Terkumpul:<span> Rp 35.000</span></p>
                                    <p>Target:<span> - </span></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo base_url() . 'assets/frontend/img/dkd/zakat_mal.png' ?>" alt="">
                            </div>
                            <div class="cases-caption">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo base_url() . 'assets/frontend/img/dkd/palestina.png' ?>" alt="">
                            </div>
                            <div class="cases-caption">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo base_url() . 'assets/frontend/img/dkd/sedekah_santri.png' ?>" alt="">
                            </div>
                            <div class="cases-caption">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo base_url() . 'assets/frontend/img/dkd/ustad.png' ?>" alt="">
                            </div>
                            <div class="cases-caption">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo base_url() . 'assets/frontend/img/dkd/tebar_alquran.png' ?>" alt="">
                            </div>
                            <div class="cases-caption">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo base_url() . 'assets/frontend/img/dkd/yatim.png' ?>" alt="">
                            </div>
                            <div class="cases-caption">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo base_url() . 'assets/frontend/img/dkd/puasa.png' ?>" alt="">
                            </div>
                            <div class="cases-caption">
