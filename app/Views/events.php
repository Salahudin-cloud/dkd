...
<body>
    ...
    <main>
        ...
        <!-- Featured_job_start -->
        <section class="featured-job-area section-padding30 section-bg2" data-background="<?php echo base_url() . 'assets/img/gallery/section_bg03.png' ?>">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="#"><img src="<?php echo base_url() . 'assets/img/dkd/event/paket_puasa.jpg' ?>" height="178" width="174" alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="#">
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="#"><img src="<?php echo base_url() . 'assets/img/dkd/event/beasiswa.jpg' ?>" height="178" width="174" alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="#">
